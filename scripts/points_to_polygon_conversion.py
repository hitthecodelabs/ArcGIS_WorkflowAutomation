...
'''
arcpy.management.PointsToLine(
    Input_Features="Hoja1$HonorioAbsalonGarcia",
    Output_Feature_Class=r"Default.gdb\Hoja1Garcia_PointsToLine1",
    Line_Field=None,
    Sort_Field=None,
    Close_Line="CLOSE",
    Line_Construction_Method="CONTINUOUS",
...
arcpy.management.FeatureToPolygon(
    in_features="Hoja1HonorioAbsalonGarcia_PointsToLine1",
    out_feature_class=r"project_folder\Default.gdb\Hoja1HonorioAb_FeatureToPoly",
